...
var config = {
  ...
  SuveyToken: "DW-194410", //Pass survey token here created using Postman", //Pass survey token here created using Postman
...
window.onload = function () {
  ...
  // };
    ...
    document.getElementById("w3mission2").value = '';
